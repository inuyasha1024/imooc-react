        ...
        return (
            ...
            <div>
                ...
                <WingBlank>
                    ...
                    <InputItem type="text" placeholder="Title" onChange={v=>{this.handleChange('title',v)}}/>
                    <InputItem type="text" placeholder="Company Name" onChange={v=>{this.handleChange('company',v)}}/>
                    <InputItem type="text" placeholder="salary" onChange={v=>{this.handleChange('salary',v)}}/>
                    <TextareaItem
